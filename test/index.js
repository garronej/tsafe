...
var names = ["withDefault", "flip", "objectKeys", "isPromiseLike", "assertIs", "exclude"];
            ...
            case 0:
                ...
                _loop_1 = function (name_1) {
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                console.log("Running: ".concat(name_1));
                            ...
                            case 1:
                                exitCode = _c.sent();
                                if (exitCode !== 0) {
                                    console.log("".concat(name_1, " exited with error code: ").concat(exitCode));
