...
import * as fs from "https://deno.land/std@0.175.0/node/fs.ts";
import { join as pathJoin } from "https://deno.land/std@0.175.0/node/path.ts";
import { getProjectRoot } from "../tools/getProjectRoot.ts";
import { exclude } from "../exclude.ts";
import { execSync } from "https://deno.land/std@0.175.0/node/child_process.ts";
